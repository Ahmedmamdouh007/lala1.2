...
2. Create a new repository (e.g. `lala-store`)
3. **Do not** initialize with README (you already have one)
4. Copy the repository URL (e.g. `https://github.com/YOUR_USERNAME/lala-store.git`)
5. Run these commands in the project folder:

```powershell
git remote add origin https://github.com/YOUR_USERNAME/lala-store.git
git branch -M main
...
gh auth login
gh repo create lala-store --private --source=. --push
```
