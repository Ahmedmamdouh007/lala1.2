#!/usr/bin/env bash
# Lala 1.2 - macOS/Linux Setup Script
...
echo -e "${CYAN}========================================${NC}"
echo -e "${CYAN}  Lala 1.2 - Setup (macOS/Linux)${NC}"
echo -e "${CYAN}========================================${NC}"
echo ""
...
if cmake -DENABLE_LABS=ON -DBUILD_MEMORY_LABS=ON .. 2>/dev/null; then
...
echo "  Test:     npm run test:api (with backend running)"
echo ""
